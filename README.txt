...
DESCRIPTION: This program source data from the Clemson University calendar website.
...
When an event is shown, the event title, location, and time appear.
HOWTO: To run this file, the user first needs to have the Beautiful Soup library installed. The user also should 
